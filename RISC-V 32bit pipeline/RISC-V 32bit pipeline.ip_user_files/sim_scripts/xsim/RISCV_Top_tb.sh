...
#
# Script generated by Vivado on Mon May 19 19:03:46 +0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RISCV_Top_tb.sh
...
#
# Usage        : RISCV_Top_tb.sh
#                RISCV_Top_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RISCV_Top_tb.sh [-reset_run]
#                RISCV_Top_tb.sh [-reset_log]
#                RISCV_Top_tb.sh [-help]
#
...
# script info
echo -e "RISCV_Top_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RISCV_Top_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot RISCV_Top_tb xil_defaultlib.RISCV_Top_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RISCV_Top_tb -key {Behavioral:sim_1:Functional:RISCV_Top_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="A:/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RISCV_Top_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RISCV_Top_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RISCV_Top_tb.sh [-help]\n\
Usage: RISCV_Top_tb.sh [-step]\n\
Usage: RISCV_Top_tb.sh [-lib_map_path]\n\
Usage: RISCV_Top_tb.sh [-reset_run]\n\
Usage: RISCV_Top_tb.sh [-reset_log]\n\
Usage: RISCV_Top_tb.sh [-keep_index]\n\
Usage: RISCV_Top_tb.sh [-noclean_files]\n\n\
